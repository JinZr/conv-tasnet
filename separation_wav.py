...
from audio_reader import read_wav, write_wav
...
def main():
    ...
    parser.add_argument(
        "-mix_scp",
        type=str,
        default="./Conv-TasNet/test.wav",
        help="Path to mix scp file.",
    )
    parser.add_argument(
        "-yaml",
        type=str,
        default="./Conv-TasNet/options/train/train.yml",
        help="Path to yaml file.",
    )
    parser.add_argument(
        "-model",
        type=str,
        default="./Conv-TasNet/Conv-TasNet/best_1.pt",
