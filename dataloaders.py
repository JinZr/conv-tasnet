...
class Datasets(Dataset):
    ...
    def __init__(self, mix_scp=None, ref_scp=None, segments=None, sr=16000):
...
class DataLoaders:
    ...
    def __init__(
        self, dataset, num_workers=4, chunk_size=32000, batch_size=1, is_train=True
    ):
...
if __name__ == "__main__":
    datasets = Datasets(
        "/home/likai/data1/create_scp/cv_mix.scp",
        [
            "/home/likai/data1/create_scp/cv_s1.scp",
            "/home/likai/data1/create_scp/cv_s2.scp",
        ],
    )
    dataloaders = DataLoaders(datasets, num_workers=0, batch_size=10, is_train=False)
